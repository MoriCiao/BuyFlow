...
const About = () => {
  return (
    <section className="about md:[75%] relative z-10 m-auto flex h-full w-full flex-col items-center justify-start gap-8 rounded-xl border-4 border-[#333533]/20 bg-[#e8eddf] p-8 tracking-widest shadow-xl xl:max-w-200">
      <h1 className="text-start text-[2rem] font-bold">關於 BuyFlow</h1>
      ...
      <div className="flex flex-col gap-4">
        ...
        <h4 className="indent-[1rem] text-[1.1rem]">
