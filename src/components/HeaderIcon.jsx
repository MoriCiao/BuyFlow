...
const HeaderIcon = () => {
  ...
  return (
    <section className="header-icon sm:absolute sm:top-0 sm:left-5 text-white z-99 xl:hidden ">
      {/* Menu Icon */}
      ...
      <ol
        ...
        } flex flex-col gap-2 justify-start text-[1.5rem] py-5 items-center cursor-pointer bg-[#333533]/50 min-w-50 min-h-[15rem] -translate-x-5 transition duration-500`}
      >
        {!isAuthenticated ? (
          <>
            <li
