...
const HeaderPin = ({ handleToggle }) => {
  ...
  return (
    <div className="fixed top-0 left-1/2 z-99 flex w-full -translate-x-1/2 justify-center rounded bg-white/20 px-6 shadow-xl backdrop-blur-sm md:mt-4 md:w-[80%]">
      <nav className="nav realtive flex h-full w-full flex-col items-center justify-center py-2 select-none md:flex-row xl:justify-between">
        ...
        <div className="hidden h-full items-center gap-8 lg:flex">
          ...
          <ul className="items-center gap-4 text-[#e8eddf] lg:flex">
            {/* ----------登入邏輯---------- */}
            {!isAuthenticated ? (
              <li>
